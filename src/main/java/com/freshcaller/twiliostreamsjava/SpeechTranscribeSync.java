...
//    String localFilePath = "/Users/ppatwari/Documents/Tasks/Twilio Media Streams/twilio-streams-java/src/main/resources/brooklyn_bridge.raw";
...
//      RecognitionAudio audio = RecognitionAudio.newBuilder().setContent(content).build();
      ...
      RecognitionAudio audio = RecognitionAudio.newBuilder().setUri(localFilePath).build();
